...
3. Install the toc-org package frpom MELPA. Place a TOC tag on a TOC headline. This will indicate  where the headline is to go.  A GitHub compatible TOC will be generated as internal links.
...
Translated the corresponding bash function with copilot. It is saner to use the toc-org package.
